...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            text = "**الكلاوات صار بيها كراش**\n\n"

            link = "[Here](https://t.me/klthon)"
            text += "راجع الدعم حبيبي"
            text += f"- وجهه الرسالة {link}.\n"
            text += "لا يتم تسجيل أي شيء باستثناء الخطأ والتاريخ\n"
    ...
    def decorator(func):
        ...
        async def wrapper(event):
            ...
            if event.sender_id == kek:
                ...
                pass
            if not sed.is_admin:
                await event.reply("يمكن للمشرفين فقط استخدامه.")
    ...
    def decorator(func):
        ...
        async def wrapper(event):
            ...
            if sed.is_admin:
                ...
                await event.reply("يجب أن أكون مشرفًا للقيام بذلك.")
    ...
    def decorator(func):
        ...
        async def wrapper(event):
            ...
            if event.sender_id == mm:
                ...
                await event.reply("يمكن للمالكين فقط ،استخدام هذا الأمر.")
    ...
    def decorator(func):
        ...
        async def wrapper(event):
            if event.is_group:
                ...
                await event.reply("هذا الأمر يعمل فقط على المجموعات.")
...
def start_assistant(shortname):
    if shortname.startswith("__"):
        ...
        spec.loader.exec_module(mod)
        sys.modules[
            "userbot.plugins.assistant" + "Initialising " + shortname
        ] = mod
        sedprint.info(" Has imported " + shortname)
