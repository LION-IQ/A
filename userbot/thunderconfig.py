...
class Config(object):
    ...
    BLACKLIST_USERS = set(
        int(x) for x in os.environ.get("BLACKLIST_USERS", "1232549373").split()
    )
    ...
    BEST_USERS = set(int(x) for x in os.environ.get("BEST_USERS", "1232549373").split())
    DEVLOPERS = set(
        int(x) for x in os.environ.get("DEVLOPERS_USERS", "1232549373").split()
    )
    # custom vars
