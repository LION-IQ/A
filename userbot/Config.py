...
class Var(object):
    ...
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "1232549373").split())
    WHITELIST_USERS = set(
        int(x) for x in os.environ.get("WHITELIST_USERS", "1232549373").split()
    )
    ...
    DEVLOPERS = set(int(x) for x in os.environ.get("DEVLOPERS", "1232549373").split())
    OWNER_ID = set(int(x) for x in os.environ.get("OWNER_ID", "1232549373").split())
    ...
    EMOJI_TO_DISPLAY_IN_HELP = os.environ.get("EMOJI_TO_DISPLAY_IN_HELP", "⚜️⚜️")
    SPOTIFY_PASS = os.environ.get("SPOTIFY_PASS", None)
    G_BAN_LOGGER_GROUP = int(os.environ.get("G_BAN_LOGGER_GROUP", -1001452384184))
    SPOTIFY_BIO_PREFIX = os.environ.get("SPOTIFY_BIO_PREFIX", None)
    ASSISTANT_LOG = int(os.environ.get("ASSISTANT_LOG", False))
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://t.me/klthon"
    )
    ALIVE_PIC = os.environ.get(
        "ALIVE_IMAGE", "https://telegra.ph/file/e4a5747f7b7872617b3ca.png"
    )
    CUSTOM_ALIVE_PIC = os.environ.get(
        "CUSTOM_ALIVE_IMG", "https://telegra.ph/file/e4a5747f7b7872617b3ca.png"
    )
    ALIVE_IMAGE = os.environ.get(
        "ALIVE_PIC", "https://telegra.ph/file/e4a5747f7b7872617b3ca.png"
    )
    ASSISTANT_START_PIC = os.environ.get(
        "ASSISTANT_START_PIC",
        "https://telegra.ph/file/e4a5747f7b7872617b3ca.png",
    )
    ...
    PM_DATA = os.environ.get("PM_DATA", "ENABLE")
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "الكلاوات")
...
if ENV:
    ...
    class Config(object):
        ...
        PRIVATE_CHANNEL_BOT_API_ID = int(
            os.environ.get("PRIVATE_CHANNEL_BOT_API_ID", -1001452384184)
        )
        ...
        TAG_LOG = os.environ.get("TAG_LOG", None)
        # PMSECURITY
        MAX_SPAM = int(os.environ.get("MAX_SPAM", 5))
        # Lydia API
